...
function Carousel() {
  return (
    ...
    >
      <div
        className="carousel-indicators absolute right-0 bottom-0 left-0 flex
        justify-center p-0 mb-4"
      >
        <button
          type="button"
      ...
      <button
        ...
        flex items-center justify-center p-0 text-center border-0 hover:outline-none
      ...
      <button
        ...
        justify-center p-0 text-center border-0 hover:outline-none hover:no-underline
